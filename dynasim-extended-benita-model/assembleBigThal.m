function specification = assembleBigThal(numCellsScale)
...
specification.populations(4).size=round(numCellsScale*50);
...
specification.populations(5).size=round(numCellsScale*50);
...
specification.connections(7).mechanism_list={'iGABAA_TRN_TRN_NN'};
specification.connections(8).direction='TRN<-TC';
specification.connections(8).mechanism_list={'iAMPA_TRN_TC_NN'};
