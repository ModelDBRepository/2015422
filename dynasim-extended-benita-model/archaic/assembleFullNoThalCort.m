function specification = assembleFullNoThalCort(numCellsScale)
...
specification.populations(4).size=round(numCellsScale*1);
...
specification.populations(5).size=round(numCellsScale*2);
