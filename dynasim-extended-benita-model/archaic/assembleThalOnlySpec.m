function specification = assembleThalOnlySpec(numCellsScale)
...
specification.populations(1).name='TC';
specification.populations(1).size=round(numCellsScale*20);
specification.populations(1).equations=eqns;
specification.populations(1).mechanism_list={...
    'iAppliedCurrent',...
    'iNa_TC_AS17',...
...
specification.populations(2).name='TRN';
specification.populations(2).size=round(numCellsScale*20);
specification.populations(2).equations=eqns;
specification.populations(2).mechanism_list={...
    'iAppliedCurrent',...
    'iNa_TRN_AS17',...
...
specification.connections(1).direction='TC<-TRN';
specification.connections(1).mechanism_list={...
    'iGABAA_TC_TRN_AS17',...
    'iGABAB_TC_TRN_AS17',...
    };
specification.connections(2).direction='TRN<-TRN';
specification.connections(2).mechanism_list={'iGABAA_TRN_TRN_AS17'};
specification.connections(3).direction='TRN<-TC';
specification.connections(3).mechanism_list={'iAMPA_TRN_TC_AS17'};
