...
% Replace the relevant line of 'eqns' below with the following to run
% the simulations using Matlab version 2017a and the original
% 'coupling_addition' branch of my personal DynaSim fork at
